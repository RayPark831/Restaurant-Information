...
def get_simple_info_batch(restaurants: list) -> list:
    ...
    prompt = f"""
당신은 맛집 전문 리서처입니다.
아래 식당들의 정보를 최대한 정확하게 조사하여 JSON 배열로만 출력하세요.
다른 텍스트 없이 JSON 배열만 출력하세요. 정보가 없는 항목은 빈문자열로 처리하세요.
...
[
  {{
    "순번": 1,
    "식당명": "정확한 식당명 (한국=한글, 해외=한글/영어/현지어)",
    "카테고리": "음식 종류 (예: 한식, 일식, 중화, 양식, 카페 등)",
    "거리": "X.Xkm",
    "추천사유": {{
      "미슐랭": "3스타(2023)/2스타/1스타/빕구르망/셀렉티드 또는 빈문자열",
      "블루리본": "블루리본/레드리본 또는 빈문자열",
      "로컬인증": "현지 맛집 인증명 또는 빈문자열",
      "노포": "창업연도 (예: 1965년 창업) 또는 빈문자열",
      "백년가게": "Y 또는 빈문자열",
      "오래가게": "Y 또는 빈문자열",
      "방송_생활의달인": "Y 또는 빈문자열",
      "방송_수요미식회": "Y 또는 빈문자열",
      "방송_백종원": "출연방송명 (예: Street Food Fighter) 또는 빈문자열",
      "방송_허영만": "Y 또는 빈문자열",
      "방송_정용진": "Y 또는 빈문자열",
      "방송_전현무": "Y 또는 빈문자열",
      "방송_요리경연": "대회명 (예: 흑백요리사) 또는 빈문자열",
      "방송_더들리": "Y 또는 빈문자열",
      "방송_빅페이스": "Y 또는 빈문자열",
      "방송_기타": "기타 방송/유튜브 또는 빈문자열"
    }},
    "대기여부": "상시웨이팅필수 또는 피크타임웨이팅 또는 웨이팅없음",
    "signature1": {{"메뉴명": "대표메뉴1", "가격": "현지가격"}},
    "signature2": {{"메뉴명": "대표메뉴2", "가격": "현지가격"}},
    "signature3": {{"메뉴명": "대표메뉴3", "가격": "현지가격"}}
  }}
]
"""
    try:
...
아래 식당 정보를 최대한 정확하게 조사하여 JSON으로만 답변하세요.
다른 텍스트 없이 JSON만 출력하세요. 정보가 없는 항목은 빈문자열("")로 처리하세요.
