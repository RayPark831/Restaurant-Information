...
<style>
    ...
    .main-title { font-size: 1.6rem; font-weight: 700; margin-bottom: 0; color: #1a1a1a; }
    .subtitle   { font-size: 0.85rem; color: #888; margin-bottom: 0.5rem; }
    ...
    .menu-label  { font-size: 0.75rem; color: #ff6b35; font-weight: 600; }
    .menu-name   { font-size: 1rem; font-weight: 700; color: #1a1a1a; margin: 0.2rem 0; }
    .menu-sub    { font-size: 0.78rem; color: #888; margin-bottom: 0.3rem; }
    .menu-desc   { font-size: 0.85rem; color: #444; line-height: 1.6; margin-bottom: 0.4rem; }
    .menu-price  { font-size: 0.95rem; font-weight: 700; color: #ff6b35; }

    .badge {
        display: inline-block;
        background: #fff3e0; color: #b35c00;
        border-radius: 20px; padding: 3px 10px;
        font-size: 0.78rem; margin: 2px;
        border: 1px solid #ffe0b2;
    }
    .badge-blue  { background: #e3f2fd; color: #1565c0; border-color: #bbdefb; }
    .badge-green { background: #e8f5e9; color: #2e7d32; border-color: #c8e6c9; }
    .badge-red   { background: #fce4ec; color: #c62828; border-color: #f8bbd0; }

    .restaurant-title { font-size: 1.5rem; font-weight: 800; color: #1a1a1a; margin: 0.5rem 0 0.3rem; }

    .stButton > button      { min-height: 48px !important; font-size: 1rem !important; border-radius: 10px !important; }
    .stTextInput > div > div > input { font-size: 1rem !important; min-height: 48px !important; border-radius: 10px !important; }
